...
### REQ-PC-003: `FiscalPeriod` SHALL declare a declarative open → closing → closed → audit-locked lifecycle
...
### REQ-PC-006: Reopening a closed period SHALL require elevated role + audit-trailed reason
