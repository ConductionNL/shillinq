...
### REQ-BCA-002: The `Appointment` schema SHALL declare a minimum field set with typed relations
...
### REQ-BCA-003: Appointment duration MUST match the related Service duration
...
### REQ-BCA-004: Appointment creation MUST validate resource availability and prevent double-booking
...
### REQ-BCA-006: Appointment creation MUST validate customer eligibility and access rules
...
### REQ-BCA-007: Appointment creation MUST persist audit trail information
...
### REQ-BCA-008: Appointment creation via REST API MUST validate request payload
...
### REQ-BCA-009: Admin appointment creation UI MUST provide confirmation feedback
...
### REQ-BCA-010: Customer self-service portal MUST enforce access control
