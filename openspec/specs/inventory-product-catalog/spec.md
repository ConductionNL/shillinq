...
### REQ-IPC-002: The `Product` schema SHALL declare a fixed minimum field set
...
### REQ-IPC-003: The system SHALL store product attribute definitions as an OpenRegister-managed `ProductAttribute` register
...
### REQ-IPC-004: The `ProductAttribute` schema SHALL declare a fixed minimum field set
...
### REQ-IPC-005: Multi-barcode support SHALL encode format and type information
...
### REQ-IPC-006: The system SHALL ship ProductAttribute seed templates for common categories
...
### REQ-IPC-007: The repair step SHALL seed ProductAttribute templates on first install, idempotently
...
### REQ-IPC-008: Product catalog SHALL be reachable through the app manifest navigation
...
### REQ-IPC-009: Product status SHALL support active and discontinued states
...
### REQ-IPC-010: The `Product` register SHALL support multi-tenancy via organizationId
