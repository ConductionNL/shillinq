...
**Scope**: shillinq
**OpenSpec changes**:
- segregation-control-real-check (2026-07-14, archived)
...
criterion that was previously never actually checked. See
`openspec/changes/archive/2026-07-14-segregation-control-real-check/design.md`
