...
### REQ-BC-007: Manifest navigation entry SHALL declare Bank Connections index and detail pages
...
### REQ-BC-008: New-transaction notifications SHALL be declared via x-openregister-notifications on BankStatement
