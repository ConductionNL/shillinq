...
@e2e exclude unbuilt UI: year-end close UI not yet implemented


### REQ-YEC-001: Declare ClosingEntry register
...
### REQ-YEC-002: Declare RetainedEarnings register
...
### REQ-YEC-003: Declare ClosingAccount register
...
### REQ-YEC-004: Declare ClosingEntryTemplate register
...
### REQ-YEC-005: FiscalYear lifecycle — open → in-progress → closed
...
### REQ-YEC-006: Closing checklist with declarative preconditions
...
### REQ-YEC-007: Archive-period locking on close
...
### REQ-YEC-008: Balance-carryforward validation
...
### REQ-YEC-009: Closing-entry materialization as GL transactions
...
### REQ-YEC-010: Automated closing-entry generation on transition
...
### REQ-YEC-011: Manifest navigation entries
...
### REQ-YEC-012: Seed data — closing-entry templates
