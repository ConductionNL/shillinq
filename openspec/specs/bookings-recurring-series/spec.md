...
# Spec: Booking Recurring Appointment Series

**Status:** done
**Scope:** shillinq

RRULE-driven recurring appointment series generation, reusing the existing
`SlotService` availability/conflict engine. Realised by `bookings-depth`
(archived 2026-07-14).
