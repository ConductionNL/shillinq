...
### REQ-FA-004: `FixedAsset` SHALL declare a declarative lifecycle with automatic depreciation-schedule generation
...
### REQ-FA-005: Depreciation rates SHALL respect Nextcloud System Settings Float Precision
...
### REQ-FA-007: Depreciation-expense GL postings SHALL be declarative, not PHP service-driven
...
### REQ-FA-008: Asset acquisition and retirement SHALL materialise balanced GL postings
...
### REQ-FA-009: Depreciation aggregations SHALL enable cost-center and method-based reporting
...
### REQ-FA-010: Fixed Assets SHALL be reachable through the shillinq manifest navigation
