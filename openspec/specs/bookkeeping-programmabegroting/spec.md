...
### REQ-001: Programmabegroting SHALL be declared as a master register with version, organisationType, status, and sluitend-flags
...
### REQ-002: Programma registers SHALL declare locally-chosen political structure with aggregated baten/lasten
...
### REQ-003: Taakveld registers SHALL declare BBV-mandated field indeling with baten/lasten per taakveldCode
...
### REQ-004: Indicator registers SHALL capture beleidsindicatoren per Programma per jaar with realisatie tracking
...
### REQ-005: Investering registers SHALL declare capital investments with dekking-type and afschrijvingstermijn
...
### REQ-006: Reserve and Voorziening registers SHALL track balances and mutations per BBV Article 44
...
### REQ-007: Paragraaf registers SHALL declare the seven mandated sections with narrative and kerncijfers
...
### REQ-008: Meerjarenraming registers SHALL declare 4-year outlook with sluitend-criteria per year
...
### REQ-009: Begrotingswijziging registers SHALL implement event-sourced delta workflow with raadsbesluit requirement
...
### REQ-010: Budget-overrun detection SHALL prevent GL postings exceeding authorized lasten per programma
...
### REQ-011: Programmabegroting lifecycle SHALL enforce sluitend-evaluation and paragraaf-validation on vaststelling
...
### REQ-012: Export integrations SHALL produce iv3-aanlevering (CBS), EMU-saldo (Wet Hof), and JSON (OpenCatalogi)
