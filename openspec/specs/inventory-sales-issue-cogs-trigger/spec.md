...
**Scope**: shillinq
**OpenSpec changes**:
- inventory-sales-issue-cogs-trigger (2026-07-13, archived)
...
`StockMove` per stock-tracked line, and a cancelled `Delivery` reverses it
through the existing `StockMove.cancel` transition. No valuation or
