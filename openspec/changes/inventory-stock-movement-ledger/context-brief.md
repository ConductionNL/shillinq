...
# Inventory Immutable Stock-move Ledger

## Placement & Information Architecture

**Placement type:** `SUB_PAGE` — Sub-page beneath a top-level menu entry. Renders as a page inside the parent surface (usually reachable via a router child route or a tab on the parent index page).

**Lives at:** Voorraad / Voorraadbewegingen

**Rationale:** Immutable move ledger page.  
...
Immutable ledger of stock moves with audit trail. Odoo's double-entry + Tryton's Stock Move pattern.
