# Context Brief: Bank Connectors (PSD2)
...
**Lives at:** Beheer / Bankkoppelingen

**Rationale:** PSD2 consenten — pure config.  
...
### GoCardless/Nordigen Open Banking integration for European bank feeds
**demand: 193** (63 tender mentions) | Category: integration

### Automatic bank feed import from 21,000+ financial institutions worldwide
**demand: 70** (22 tender mentions) | Category: document-management

### Automatic bank connection via PSD2 for real-time transaction import
**demand: 58** (18 tender mentions) | Category: document-management

### 6,000+ European bank connections via single API
**demand: 53** (17 tender mentions) | Category: integration

### Automatic daily bank transaction import and synchronization
**demand: 41** (4 tender mentions) | Category: document-management

### Tink Link pre-built bank authentication UI
**demand: 41** (13 tender mentions) | Category: security

### Automatic bank transaction import from connected accounts
**demand: 39** (4 tender mentions) | Category: document-management
