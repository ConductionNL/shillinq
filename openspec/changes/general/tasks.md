...
- [x] 1.1 Add `KpiWidget` schema to `lib/Settings/shillinq_register.json`
...
- [x] 1.2 Add `AnalyticsReport` schema to `lib/Settings/shillinq_register.json`
  - **spec_ref**: `specs/general/spec.md#REQ-GEN-001`
  - **files**: `lib/Settings/shillinq_register.json`
  - **acceptance_criteria**:
...
- [x] 1.3 Add `PortalToken` schema to `lib/Settings/shillinq_register.json`
...
- [x] 1.4 Add `AutomationRule` schema to `lib/Settings/shillinq_register.json`
...
- [x] 1.5 Add `ExpenseClaim` schema to `lib/Settings/shillinq_register.json`
...
- [x] 1.6 Add `ExpenseItem` schema to `lib/Settings/shillinq_register.json`
  - **spec_ref**: `specs/general/spec.md#REQ-GEN-005`
  - **files**: `lib/Settings/shillinq_register.json`
  - **acceptance_criteria**:
    - GIVEN the schema is registered
...
- [x] 2.1 Add KpiWidget seed objects to `lib/Repair/CreateDefaultConfiguration.php`
...
- [x] 2.2 Add AutomationRule seed object to Repair step
  - **spec_ref**: `specs/general/spec.md#REQ-GEN-008`
  - **files**: `lib/Repair/CreateDefaultConfiguration.php`
  - **acceptance_criteria**:
...
- [x] 2.3 Add ExpenseClaim and AnalyticsReport seed objects to Repair step
  - **spec_ref**: `specs/general/spec.md#REQ-GEN-008`
  - **files**: `lib/Repair/CreateDefaultConfiguration.php`
  - **acceptance_criteria**:
    - GIVEN a fresh install
...
- [x] 3.1 Create `src/store/modules/analytics.js`
...
- [x] 3.4 Create `src/store/modules/expenseClaim.js` and `src/store/modules/expenseItem.js`
...
- [x] 4.1 Implement `src/views/analytics/AnalyticsDashboard.vue`
  - **spec_ref**: `specs/general/spec.md#REQ-GEN-002`
...
- [x] 4.2 Implement `src/views/analytics/KpiWidgetCard.vue`
...
- [x] 4.3 Implement `src/views/analytics/AnalyticsReportList.vue` and `AnalyticsReportDetail.vue`
...
- [x] 5.1 Implement `src/views/portal/PortalTokenList.vue` and `PortalTokenDetail.vue`
  - **spec_ref**: `specs/general/spec.md#REQ-GEN-003`
...
- [x] 5.2 Implement `src/views/portal/PortalInvoiceList.vue`
...
- [x] 6.1 Create `src/views/automationRule/AutomationRuleList.vue` and `AutomationRuleDetail.vue`
  - **spec_ref**: `specs/general/spec.md#REQ-GEN-004`
...
- [x] 6.2 Create `src/views/automationRule/AutomationRuleForm.vue`
...
- [x] 6.3 Implement `lib/BackgroundJob/AutomationRuleJob.php`
  - **spec_ref**: `specs/general/spec.md#REQ-GEN-004`
...
- [x] 6.4 Implement `lib/Service/AutomationRuleEvaluator.php`
...
- [x] 7.1 Create `src/views/expenseClaim/ExpenseClaimList.vue`
  - **spec_ref**: `specs/general/spec.md#REQ-GEN-005`
...
- [x] 7.2 Create `src/views/expenseClaim/ExpenseClaimDetail.vue`
...
- [x] 7.3 Create `src/views/expenseClaim/ExpenseClaimForm.vue` — multi-step
  - **spec_ref**: `specs/general/spec.md#REQ-GEN-005`
...
- [x] 8.1 Implement `src/components/BulkActionBar.vue`
...
- [x] 8.2 Implement `lib/Controller/BulkActionController.php`
  - **spec_ref**: `specs/general/spec.md#REQ-GEN-006`
...
- [x] 8.3 Integrate `BulkActionBar` into all entity list views
...
- [x] 9.1 Implement `src/components/QuickActionsPanel.vue`
...
- [x] 10.1 Update `src/navigation/MainMenu.vue` with new sections
...
- [x] 10.2 Update `src/router/index.js` with new routes
...
- [x] 11.1 Implement `lib/Service/PortalService.php`
  - **spec_ref**: `specs/general/spec.md#REQ-GEN-003`
...
- [x] 11.2 Implement `lib/Service/AnalyticsService.php`
  - **spec_ref**: `specs/general/spec.md#REQ-GEN-002`
...
- [x] 11.3 Implement `lib/Service/BulkActionService.php`
  - **spec_ref**: `specs/general/spec.md#REQ-GEN-006`
...
- [x] 11.4 Register new routes in `appinfo/routes.php`
...
- [x] 12.1 Add English translations for all new UI strings
  - **files**: `l10n/en.json`
  - **acceptance_criteria**:
...
- [x] 13.1 Add unit tests for `AutomationRuleEvaluator.php`
...
- [x] 13.2 Add unit tests for `PortalService.php`
...
- [x] 13.3 Add unit tests for `BulkActionService.php`
