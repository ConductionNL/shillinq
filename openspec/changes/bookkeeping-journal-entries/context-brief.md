# Context Brief: Journal Entries (Memoriaalboekingen)
...
**Lives at:** Boekhouding / Memoriaalboekingen

**Rationale:** Foundation T1.  
...
### Inter-company invoice management with automatic elimination entries
**demand: 1594** (530 tender mentions) | Category: other

### Cancelling a Journal Entry now adds the default linked records to the ignore list while keeping any doctypes already present, so custom app records are no longer removed from the list. (https://github.com/frappe/[competitor]/pull/53336)
**demand: 83** (27 tender mentions) | Category: other

### Inter-company posting with automatic elimination entries
**demand: 50** (14 tender mentions) | Category: other

### Transaction template creation for frequently used entries
**demand: 41** (13 tender mentions) | Category: document-management
