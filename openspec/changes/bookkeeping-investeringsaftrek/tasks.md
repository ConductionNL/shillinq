...
> `opsx-apply` cycle will execute against the `bookkeeping-investeringsaftrek`
...
- [ ] Task 1: Confirm no `bookkeeping-investeringsaftrek` capability spec
...
- [ ] Task 2: Confirm dependency on `bookkeeping-fixed-assets-depreciation`
...
- [ ] Task 3: Author `specs/bookkeeping-investeringsaftrek/spec.md` with
...
- [ ] Task 4: Author `proposal.md` referencing shared `nextcloud-app` spec
...
- [ ] Task 5: Author `design.md` with Reuse Analysis table, D1 (six entities
...
- [ ] Task 6: Add `InvestmentAsset` entity to `openspec/architecture/adr-000-data-model.md`
...
- [ ] Task 7: Add `EnergielijstCode` entity to ADR-000 with all REQ-INV-002
...
- [ ] Task 8: Add `MilieulijstCode` entity to ADR-000 with all REQ-INV-003
...
- [ ] Task 9: Add `InvesteringsaftrekClaim` entity to ADR-000 with all fields
...
- [ ] Task 10: Add `VamilDepreciation` entity to ADR-000 with all fields
...
- [ ] Task 11: Add `KIATier` entity to ADR-000 with all fields (`tier`,
  `vanaf`, `tot`, `percentage`, `vastBedrag`, `regel`); 2026 tiers
  pre-populated (5 rows per Wet IB 2001 art. 3.41); Schema.org annotation
  `schema:DefinedTerm`

- [ ] Task 12: Implement InvestmentAsset eligibility classification logic
...
- [ ] Task 13: Implement Energielijst/Milieulijst lookup per REQ-INV-002:
...
- [ ] Task 14: Implement threshold validation per REQ-INV-003: EUR 2.5k
...
- [ ] Task 15: Implement cumulation matrix validation per REQ-INV-004:
...
- [ ] Task 16: Implement KIA tier calculation per REQ-INV-005 + REQ-INV-006:
...
- [ ] Task 17: Implement RvO aanvraag generation per REQ-INV-007: capture
...
- [ ] Task 18: Implement Jaaraangifte Bijlage Investeringsaftrek per
...
- [ ] Task 19: Implement vrijwillige verlaging tracking per REQ-INV-009:
...
- [ ] Task 20: Implement desinvesteringsbijtelling on disposal per
...
- [ ] Task 21: Implement ex-ante calculator per REQ-INV-011: "what-if" mode
...
- [ ] Task 22: Implement audit trail & RvO-correspondentie-archief per
...
- [ ] Task 23: Declare `InvestmentAsset` aftrek calculations as
...
- [ ] Task 24: Register 2 openconnector RvO sources: (a) aanvraag submission
...
- [ ] Task 25: Register RvO aanvraagdossier docudesk template with all
...
- [ ] Task 26: Add 4 manifest navigation entries to `src/manifest.json`
...
- [ ] Task 27: Update `openspec/architecture/adr-000-data-model.md` with
...
- [ ] Task 28: Create `lib/Settings/seeds/investeringsaftrek-energielijst-2026.json`
...
- [ ] Task 29: Create `lib/Settings/seeds/investeringsaftrek-milieulijst-2026.json`
...
- [ ] Task 30: Create `lib/Settings/seeds/investeringsaftrek-kia-tiers-2026.json`
...
- [ ] Task 31: Add Dutch (`nl_NL`) + English (`en_US`) i18n strings per
...
- [ ] Task 32: Document ex-ante calculator as separate journeydoc per
...
- [ ] Task 33: Add `hydra.json` entry for this change with links to all
