...
- [ ] 1.1 Add `role` schema to `lib/Settings/shillinq_register.json`
...
- [ ] 1.2 Add `team` schema to `lib/Settings/shillinq_register.json`
  - **spec_ref**: `specs/access-control-authorisation/spec.md#REQ-AC-001`
  - **files**: `lib/Settings/shillinq_register.json`
  - **acceptance_criteria**:
...
- [ ] 1.3 Add `user` schema to `lib/Settings/shillinq_register.json`
  - **spec_ref**: `specs/access-control-authorisation/spec.md#REQ-AC-001`
  - **files**: `lib/Settings/shillinq_register.json`
  - **acceptance_criteria**:
    - GIVEN the schema is registered
...
- [ ] 1.4 Add `accessControl` schema to `lib/Settings/shillinq_register.json`
  - **spec_ref**: `specs/access-control-authorisation/spec.md#REQ-AC-001`
  - **files**: `lib/Settings/shillinq_register.json`
  - **acceptance_criteria**:
    - GIVEN the schema is registered
...
- [ ] 1.5 Add `accessRight`, `accessRecertification`, and `permission` schemas to `lib/Settings/shillinq_register.json`
...
- [ ] 2.1 Add five built-in Role seed objects to `lib/Repair/CreateDefaultConfiguration.php`
...
- [ ] 2.2 Add Team and AccessControl seed objects to repair step
...
- [ ] 3.1 Create `lib/Middleware/PermissionGateMiddleware.php`
  - **spec_ref**: `specs/access-control-authorisation/spec.md#REQ-AC-002`
...
- [ ] 3.2 Create `lib/Service/AuditLogService.php`
...
- [ ] 3.3 Create `lib/Service/FieldSecurityService.php`
...
- [ ] 3.4 Create `lib/Service/PurchasingLimitService.php`
...
- [ ] 3.5 Create `lib/Service/DelegationService.php`
...
- [ ] 3.6 Create `lib/Service/RecertificationService.php`
...
- [ ] 4.1 Create `lib/BackgroundJob/DelegationExpiryJob.php`
  - **spec_ref**: `specs/access-control-authorisation/spec.md#REQ-AC-007`
...
- [ ] 4.2 Create `lib/BackgroundJob/RecertificationNotificationJob.php`
  - **spec_ref**: `specs/access-control-authorisation/spec.md#REQ-AC-008`
...
- [ ] 5.1 Create `lib/Controller/RoleController.php`
...
- [ ] 5.2 Create `lib/Controller/TeamController.php`
...
- [ ] 5.3 Create `lib/Controller/UserController.php`
...
- [ ] 5.4 Create `lib/Controller/AccessControlController.php`
...
- [ ] 5.5 Create `lib/Controller/DelegationController.php` and `lib/Controller/RecertificationController.php`
...
- [ ] 5.6 Create `lib/Controller/ReportController.php`
...
- [ ] 6.1 Create `src/store/modules/role.js`
...
- [ ] 6.6 Register all six new stores in `src/store/store.js`
...
- [ ] 7.1 Create `src/views/role/RoleIndex.vue`
  - **spec_ref**: `specs/access-control-authorisation/spec.md#REQ-AC-002`
...
- [ ] 7.2 Create `src/views/role/RoleDetail.vue`
...
- [ ] 8.1 Create `src/views/team/TeamIndex.vue`
  - **spec_ref**: `specs/access-control-authorisation/spec.md#REQ-AC-003`
...
- [ ] 8.2 Create `src/views/team/TeamDetail.vue` and `src/views/team/TeamInviteDialog.vue`
...
- [ ] 9.1 Create `src/views/user/UserIndex.vue`
...
- [ ] 9.2 Create `src/views/user/UserDetail.vue`
...
- [ ] 10.1 Create `src/views/accessControl/AccessControlIndex.vue`
  - **spec_ref**: `specs/access-control-authorisation/spec.md#REQ-AC-009`
...
- [ ] 10.2 Create `src/views/accessControl/AccessControlDetail.vue`
...
- [ ] 11.1 Create `src/views/delegation/DelegationDialog.vue`
  - **spec_ref**: `specs/access-control-authorisation/spec.md#REQ-AC-007`
...
- [ ] 11.2 Create `src/views/recertification/RecertificationIndex.vue` and `RecertificationReview.vue`
  - **spec_ref**: `specs/access-control-authorisation/spec.md#REQ-AC-008`
...
- [ ] 12.1 Create `src/views/report/AccessRightsReport.vue`
  - **spec_ref**: `specs/access-control-authorisation/spec.md#REQ-AC-010`
...
- [ ] 13.1 Update `src/navigation/MainMenu.vue` to add Security section
...
- [ ] 14.1 Add all new routes to `src/router/index.js`
...
- [ ] 15.1 Add English translations in `l10n/en.json` for all access control UI strings
  - **files**: `l10n/en.json`
  - **acceptance_criteria**:
...
- [ ] 15.2 Add Dutch translations in `l10n/nl.json`
  - **files**: `l10n/nl.json`
  - **acceptance_criteria**:
...
- [ ] 16.1 Add unit tests for `PermissionGateMiddleware.php`
...
- [ ] 16.2 Add unit tests for `FieldSecurityService.php`
...
- [ ] 16.3 Add unit tests for `PurchasingLimitService.php`
...
- [ ] 16.4 Add unit tests for `DelegationExpiryJob.php`
