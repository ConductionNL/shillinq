...
### REQ-BBV-001: The system SHALL provide BBV-conformant posting infrastructure for decentralised government administrations
...
### REQ-BBV-003: GL postings on municipal administrations SHALL require a valid `BbvAccountMapping` before transitioning to `posted`
...
### REQ-BBV-004: BBV reporting fields SHALL be derived from declarative aggregations, not service methods
...
### REQ-BBV-005: BBV taakveld catalogue SHALL ship as versioned seed data
...
### REQ-BBV-006: The default RGS-to-BBV mapping SHALL ship as `rgs-to-bbv-mapping.json` seed
...
### REQ-BBV-007: BBV mappings SHALL be reachable through the shillinq manifest navigation
...
### REQ-BBV-008: Audit trail and retention SHALL be consumed from OR's abstractions
...
### REQ-BBV-009: BBV mapping changes SHALL be subject to approval-workflow per administration policy
