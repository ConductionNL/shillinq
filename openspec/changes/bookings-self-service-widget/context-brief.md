...
# Booking Self-service Widget (embeddable JS)
...
**Lives at:** Beheer / Integraties → Self-service-widget embed

**Rationale:** Pure embed-code config.  
...
Embeddable JS widget for any salon/clinic website.
