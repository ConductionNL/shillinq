...
### REQ-EMU-001: The system SHALL compute EMU-saldo and EMU-schuld per ESA 2010 conventions
...
### REQ-EMU-002: The system SHALL declare an ESA-2010 sector classifier on every Account
...
### REQ-EMU-003: The system SHALL produce EMU-saldo quarterly via IV3 and annually via jaarrekening
...
### REQ-EMU-004: Per-sector EMU inclusion/exclusion rules SHALL be declared as calculation metadata, not hard-coded
...
### REQ-EMU-005: EMU computation results SHALL be reproducible from the audit-trail
...
### REQ-EMU-006: EMU reporting SHALL be reachable through a feature-flag-controlled manifest navigation entry
