...
### REQ-RV-001: The system SHALL run automatic lightweight toetsing on journaalpost creation
...
### REQ-RV-002: The system SHALL support manual material criteria with evidence attachment
...
### REQ-RV-003: The system SHALL configure tolerantiegrens per fiscal year
...
### REQ-RV-004: The system SHALL maintain an immutable audit trail per toets and bevinding
...
### REQ-RV-005: The system SHALL aggregate findings against tolerances into a rechtmatigheidsparagraaf
...
### REQ-RV-006: The system SHALL export the finalized paragraaf to the jaarrekening (BBV-conform)
...
### REQ-RV-007: The system SHALL apply drempelbedragen and clustering detection for europees aanbesteden
...
### REQ-RV-008: The system SHALL integrate toetsing with procurement and obligations
...
### REQ-RV-009: The system SHALL provide reporting and dashboards per programma and portefeuille
...
### REQ-RV-010: The system SHALL link correctieboekingen and resolve bevindingen
