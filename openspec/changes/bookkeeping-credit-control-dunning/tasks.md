...
- [ ] Task 12: Implement the `APTransaction` lifecycle transitions per REQ-CCD-005 —
...
- [ ] Task 19: Implement the optional credit-score-fetch per REQ-CCD-007 — if credit-score
...
- [ ] Task 20: Implement the optional overdraft-incasso-API POST per REQ-CCD-008 — at
...
- [ ] Task 21: Implement the optional PostNL aangetekende-post-API per REQ-CCD-009 — if
...
- [ ] Task 22: Implement the optional oninbare-afschrijving per REQ-CCD-010 — on operator
...
- [ ] Task 23: Implement the anti-pattern-detector per REQ-CCD-011 — before stage 1
...
- [ ] Task 25: Wire up `bookkeeping-document-attachment-integration` FK contract: all
...
- [ ] Task 26: Wire up `bookkeeping-general-ledger` GL-posting for write-off per REQ-CCD-010:
...
- [ ] Task 27: Wire up `bookkeeping-btw-aangifte` BTW-teruggaaf-preparation per REQ-CCD-010:
...
- [ ] Task 28: Create docudesk template library for dunning-stages 1–5 (docudesk project):
