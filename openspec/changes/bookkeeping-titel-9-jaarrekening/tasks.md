...
> **Spec-only change.** Per `proposal.md` Scope, implementation code is deliberately out of scope here. The tasks below describe the work an `opsx-apply` cycle will execute against the `bookkeeping-titel-9-jaarrekening` spec — they are recorded now so the spec-review gate, dependency planning, and tier-cascade impact are all visible at proposal time. No source files are edited by this change itself.

---

## Tasks

- [ ] **Task 1: Confirm no prior jaarrekening-generatie capability exists**  
...
- [ ] **Task 2: Author `specs/bookkeeping-titel-9-jaarrekening/spec.md`**  
...
- [ ] **Task 5: Declare `AnnualReport`, `BalanceSheet`, `IncomeStatement`, `CashFlowStatement`, `Note`, `DirectorReport`, `ReviewWorkflow` schemas in `lib/Settings/shillinq_register.json`**  
...
- [ ] **Task 6: Declare `groottecategorie` classification enum and logic**  
...
- [ ] **Task 7: Declare wettelijke rubriek structure on `BalanceSheet` and `IncomeStatement`**  
...
- [ ] **Task 8: Declare toelichting-template registry and mandatory-note schema**  
...
- [ ] **Task 9: Declare kasstroomoverzicht (RJ 350) schema on `CashFlowStatement`**  
...
- [ ] **Task 10: Declare bestuursverslag sections and auto-population fields on `DirectorReport`**  
...
- [ ] **Task 11: Declare `ReviewWorkflow` state machine per REQ-T9-010**  
...
- [ ] **Task 12: Add groottecategorie-determination seed configuration**  
...
- [ ] **Task 13: Add balans-rubriek-mapping seed**  
...
- [ ] **Task 14: Add IncomeStatement-model-selection seed**  
...
- [ ] **Task 15: Declare mandatory-notes registry keyed to groottecategorie**  
...
- [ ] **Task 16: Implement groottecategorie-classification service (opsx-apply phase)**  
...
- [ ] **Task 17: Implement balans-generation service (opsx-apply phase)**  
...
- [ ] **Task 18: Implement V&W-generation service, model-switching logic (opsx-apply phase)**  
...
- [ ] **Task 19: Implement toelichting-generation templating engine (opsx-apply phase)**  
...
- [ ] **Task 20: Implement kasstroomoverzicht (RJ 350) generation, indirect method (opsx-apply phase)**  
...
- [ ] **Task 21: Implement bestuursverslag (Director's Report) auto-population (opsx-apply phase)**  
...
- [ ] **Task 22: Implement ReviewWorkflow orchestration and state machine (opsx-apply phase)**  
...
- [ ] **Task 23: Implement immutability and audit-trail snapshots (opsx-apply phase)**  
...
- [ ] **Task 24: Implement groottecategorie-driven template selection (opsx-apply phase)**  
...
- [ ] **Task 25: Wire accountant-review UI and permission model (opsx-apply phase)**  
...
- [ ] **Task 26: Implement accountantsverklaring attachment and rendering (opsx-apply phase)**  
...
- [ ] **Task 27: Seed groottecategorie-classification, balans-rubriek, V&W-model, toelichting-registry data (opsx-apply phase)**  
...
- [ ] **Task 28: Extend manifest.json with Jaarrekening navigation (opsx-apply phase)**  
...
- [ ] **Task 29: Implement termijn-tracking and deadline-reminder system (opsx-apply phase)**  
...
- [ ] **Task 30: Implement Digipoort integration stub (opsx-apply phase) — DEFER to bookkeeping-sbr-xbrl-reporting**  
...
- [ ] **Task 31: Update `openspec/architecture/adr-000-data-model.md` with reconciliation notes**  
...
- [ ] **Task 32: Validate `openspec validate` and architecture review**  
