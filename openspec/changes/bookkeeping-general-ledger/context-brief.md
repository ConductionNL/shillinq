...
**Lives at:** Boekhouding / Grootboek

**Rationale:** Foundation T1 — the kern.  
...
### The "General Ledger" link in Asset Repair now uses the repair’s Completion Date instead of the Posting Date as the starting date when opening the ledger. (https://github.com/frappe/[competitor]/pull/53377)
**demand: 224** (74 tender mentions) | Category: other

### Adds an "Accounting Ledger" button to submitted Asset Repair forms, letting you open the General Ledger for the selected repair. (https://github.com/frappe/[competitor]/pull/53372)
**demand: 170** (56 tender mentions) | Category: other

### General Ledger Report
**demand: 119** (37 tender mentions) | Category: analytics

### FIX: accountancy general ledger: bad handling of hook return by @marc-dll in https://github.com/Dolibarr/dolibarr/pull/34029
