...
# Spec: bookkeeping-aansluitingen

**Status:** proposed
**Scope:** shillinq
**Tier:** T3 (compliance + control engine features)
**Depends on:** `../bookkeeping-vat-btw-filing/spec.md` (VATReturnService GL derivation),
`../bookkeeping-period-close/spec.md` (FiscalPeriod, PeriodCloseAssistantService open-item detection),
`../bookkeeping-trial-balance/spec.md` (REQ-TB-001 declarative-aggregation precedent)
