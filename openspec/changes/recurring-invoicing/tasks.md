...
- [ ] Task 1: Confirm no recurring/periodic invoicing exists: no
...
- [ ] Task 3: Declare the `nextRunDate` calculation per REQ-RIN-003
...
- [ ] Task 4: Declare the profile lifecycle per REQ-RIN-005
...
- [ ] Task 5: Declare the scheduled generation workflow per REQ-RIN-002
...
- [ ] Task 6: Declare the four `x-openregister-notifications` rules per
...
- [ ] Task 7: Implement generation per REQ-RIN-002 — declaratively if the
...
- [ ] Task 8: Implement idempotency + catch-up per REQ-RIN-004: the
...
- [ ] Task 9: Implement annual indexation per REQ-RIN-006: apply
...
- [ ] Task 10: [CHAINED: bookkeeping-quote-order-invoice] Activate the
...
- [ ] Task 11: [CHAINED: bookkeeping-sepa-direct-debit] Route generated
...
- [ ] Task 13: Create `src/manifest.d/recurring-invoicing.json` with the
...
- [ ] Task 14: Implement the next-invoice preview per REQ-RIN-008:
...
- [ ] Task 15: Implement the create/edit modal in its own file under
