# Context Brief: Rekenkamer / Accountantscontrole Audit Pack
...
**Lives at:** Rapportage / Audit Pack

**Rationale:** Bundling page.  
...
### detailed audit trails for each signed document
**demand: 6239** (2073 tender mentions) | Category: governance

### View signing audit trail for a document
**demand: 6222** (2073 tender mentions) | Category: governance

### Generate destruction report for audit
**demand: 3555** (45 tender mentions) | Category: governance

### audit trails
**demand: 2413** (15 tender mentions) | Category: governance

### Audit & Versioning
**demand: 2413** (15 tender mentions) | Category: governance

### History & Audit Trail
**demand: 2392** (17 tender mentions) | Category: governance

### Audit history
**demand: 2049** (22 tender mentions) | Category: governance

### Full audit trail for procurement decisions meeting public sector transparency requirements
**demand: 2009** (669 tender mentions) | Category: governance

### PO change order management with version tracking and audit trail
**demand: 1799** (599 tender mentions) | Category: governance

### Audit Management
**demand: 1773** (558 tender mentions) | Category: governance

### Audit management SNGRC
**demand: 1275** (424 tender mentions) | Category: governance

### View Conduct AVG/GDPR Compliance Audit overview
**demand: 1200** (63 tender mentions) | Category: governance

### Audit log for configuration changes
**demand: 1173** (49 tender mentions) | Category: governance

### Export Conduct AVG/GDPR Compliance Audit data
**demand: 1161** (50 tender mentions) | Category: governance

### CoCounsel Document Analysis for Audit
**demand: 995** (323 tender mentions) | Category: governance

### AiDA Digital Audit Assistant
**demand: 691** (229 tender mentions) | Category: governance

### Search within Security Audit Preparation
**demand: 507** (169 tender mentions) | Category: governance

### Audit trail logging all financial record changes with user and timestamp
**demand: 453** (149 tender mentions) | Category: governance

### Complete audit trail via Activity app for all decision lifecycle events
**demand: 429** (143 tender mentions) | Category: core

### Audit trail with complete change history and user attribution
**demand: 374** (122 tender mentions) | Category: governance
