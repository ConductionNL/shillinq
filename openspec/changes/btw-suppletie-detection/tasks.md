...
### Task 1: Additive `VatCorrection`/`VatReturn` register fields + audit flag + seed
...
- **acceptance_criteria**:
  ...
  - GIVEN the fragment is loaded THEN `VatReturn` and `VatCorrection` both carry `x-openregister-audit: true`
