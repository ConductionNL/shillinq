# Context Brief: Archiefwet Retention (consume OR)
...
**Lives at:** Beheer / Retentie

**Rationale:** Pure config, consume OR.  
_Source: /tmp/ia-shillinq.md_

> **Implementation note for builders:** Respect the placement above. Do not promote this spec to a top-level menu item, sub-page, or new route unless the placement type explicitly says so. If the placement is `DETAIL_TAB`, `WIDGET`, `ACTION`, `SETTING`, or `INFRA`, the feature must NOT introduce a new entry in the app sidebar. When in doubt, ask before creating a new top-level surface.

## Features (24 total, sorted by market demand)

### Configure automatic document retention and deletion
**demand: 6498** (166 tender mentions) | Category: document-management

### Set retention policy per document type
**demand: 6231** (2077 tender mentions) | Category: governance

### Link retention schedule to document type
**demand: 6225** (2075 tender mentions) | Category: document-management

### Retention period management
**demand: 4060** (415 tender mentions) | Category: other

### Retention policies
**demand: 3001** | Category: other

### Retention management
**demand: 1558** (307 tender mentions) | Category: other

### Check retention policy compliance
**demand: 1252** (78 tender mentions) | Category: governance

### Compliance & Retention
**demand: 1191** (32 tender mentions) | Category: governance

### Apply retention schedule to migrated email archive
**demand: 1026** (342 tender mentions) | Category: document-management

### Archive Talk conversations as part of decision record (Archiefwet compliance)
**demand: 497** (165 tender mentions) | Category: core

### Archive award notice for compliance retention
**demand: 495** (165 tender mentions) | Category: governance

### Assign retention category to contract record
**demand: 336** (112 tender mentions) | Category: other

### Extend retention period with documented justification
**demand: 162** (54 tender mentions) | Category: other

### Assign retention schedule code to record
**demand: 159** (53 tender mentions) | Category: scheduling

### Retention deadline alerts and review workflows
**demand: 135** (45 tender mentions) | Category: scheduling

### View contracts due for retention review
**demand: 132** (44 tender mentions) | Category: other

### Access Service Retention Program on Mobile
**demand: 119** (29 tender mentions) | Category: security

### Generate retention compliance report for DPA audit
**demand: 108** (36 tender mentions) | Category: governance

### Search Service Retention Program
**demand: 99** (29 tender mentions) | Category: other

### Assign retention schedule to case dossier
**demand: 98** (32 tender mentions) | Category: scheduling

### Set retention policy on register
**demand: 75** (25 tender mentions) | Category: governance

### View retention overview by personal data category
**demand: 72** (24 tender mentions) | Category: other

### Export Service Retention Program Data
**demand: 54** (18 tender mentions) | Category: document-management

### View Service Retention Program Overview
**demand: 42** (14 tender mentions) | Category: other
