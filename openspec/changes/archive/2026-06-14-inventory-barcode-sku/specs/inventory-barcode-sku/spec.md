...
### Requirement: REQ-SKU-001: The system SHALL store barcodes as an OpenRegister-managed `Barcode` register
...
### Requirement: REQ-SKU-002: The system SHALL support declarative SKU generation via templates
...
### Requirement: REQ-SKU-003: The `Barcode` schema SHALL declare a fixed minimum field set
...
### Requirement: REQ-SKU-004: The `Barcode` schema SHALL declare cross-schema relations via `x-openregister-relations`
...
### Requirement: REQ-SKU-005: The `Barcode` schema SHALL enforce barcode uniqueness per unit-of-measure within a product
...
### Requirement: REQ-SKU-006: The `InventoryItem` schema SHALL be patched with three additive barcode-related fields
...
### Requirement: REQ-SKU-007: The system SHALL expose a barcode lookup endpoint for POS scanning
...
### Requirement: REQ-SKU-008: Inactive barcodes SHALL NOT be returned by the lookup endpoint
...
### Requirement: REQ-SKU-009: Per-UoM quantity information SHALL be clearly presented in POS UI (design requirement for pipelinq)
...
### Requirement: REQ-SKU-010: The system SHALL provide manifest navigation for barcode management
...
### Requirement: REQ-SKU-011: Seed data SHALL include example barcodes for Dutch retail products
