...
### Requirement: REQ-DT-001: Detect temporary differences per account on balansdatum
...
### Requirement: REQ-DT-002: Distinguish permanent from temporary differences
...
### Requirement: REQ-DT-003: Manage tax-loss carry-forward per jurisdiction per regime
...
### Requirement: REQ-DT-004: Assess recoverability of DTA on loss carry-forwards
...
### Requirement: REQ-DT-005: Apply enacted tax-rate changes to expected-reversal-year differences
...
### Requirement: REQ-DT-006: Calculate and disclose effective tax rate reconciliation
...
### Requirement: REQ-DT-007: Maintain separate per-jurisdiction tracking with optional consolidation
...
### Requirement: REQ-DT-008: Salde DTA and DTL on balance sheet per IAS 12 §71–78
...
### Requirement: REQ-DT-009: Maintain deferred-tax roll-forward with complete movement detail
...
### Requirement: REQ-DT-010: Reconcile deferred-tax positions with Vpb return
