...
### Requirement: REQ-SM-001: Stock movement SHALL be declared as `StockMove` register with double-entry semantics
...
### Requirement: REQ-SM-002: The `StockMove` schema SHALL declare a fixed minimum field set
...
### Requirement: REQ-SM-003: Stock move lifecycle SHALL be `draft → posted → cancelled` with immutability lock
...
### Requirement: REQ-SM-004: Reserved quantity prevents over-allocation; draft move reserves from source
...
### Requirement: REQ-SM-005: Stock ledger: InventoryStock.quantity is reconciled by posted, non-cancelled moves
...
### Requirement: REQ-SM-006: GL materialisation: receipt increases asset, issue decreases asset + posts COGS
...
### Requirement: REQ-SM-007: Audit trail with mandatory reason code on posting
...
### Requirement: REQ-SM-008: Manifest navigation entries for Stock Movements, Stock Ledger, Reserved Stock
...
### Requirement: REQ-SM-009: Reserved quantity visibility: operator sees draft moves blocking future allocation
