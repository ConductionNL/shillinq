...
### Requirement: REQ-CPA-001: The system SHALL administer multi-project consultancy work as OpenRegister-managed registers
...
### Requirement: REQ-CPA-002: The `Project` schema SHALL declare a fixed minimum field set
...
### Requirement: REQ-CPA-003: The `Project` lifecycle SHALL be declarative per ADR-031
...
### Requirement: REQ-CPA-004: The `ProjectAssignment` schema SHALL declare a fixed minimum field set
...
### Requirement: REQ-CPA-005: The `RateCard` schema SHALL declare per-level rates with effectivity windows
...
### Requirement: REQ-CPA-006: Project costs SHALL be derived from GL aggregations, not service-side recompute
...
### Requirement: REQ-CPA-007: Recognised revenue SHALL be a declarative calculation per RJ 270 / IFRS 15
...
### Requirement: REQ-CPA-008: WIP balance SHALL be a derived field and SHOULD snapshot per period via scheduled workflow
...
### Requirement: REQ-CPA-009: Multi-rate-card boundaries SHALL snapshot the rate at hour-posting time
...
### Requirement: REQ-CPA-010: Project P&L SHALL be a declarative aggregation, not a service
...
### Requirement: REQ-CPA-011: Utilisation SHALL be a declarative calculation per person per period
...
### Requirement: REQ-CPA-012: Project administration SHALL be reachable through the shillinq manifest navigation
...
### Requirement: REQ-CPA-013: A project-utilisation dashboard widget SHALL be declared via `x-openregister-widgets`
...
### Requirement: REQ-CPA-014: Audit trail and retention SHALL be consumed from OR's abstractions
