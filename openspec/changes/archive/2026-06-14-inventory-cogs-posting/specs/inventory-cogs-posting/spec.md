...
### Requirement: REQ-CG-001: An `InventoryGLConfig` register SHALL map stock-movement event types to GL accounts per administration
...
### Requirement: REQ-CG-002: The system SHALL auto-post a COGS + Inventory Asset GLTransaction on every sale/dispatch event
...
### Requirement: REQ-CG-003: The system SHALL auto-post an Inventory Asset + GR/IR GLTransaction on every goods receipt event
...
### Requirement: REQ-CG-004: The system SHALL auto-post an Inventory Adjustment + Inventory Asset GLTransaction on every count-variance event
...
### Requirement: REQ-CG-005: Every inventory GL posting SHALL materialise a balanced GLTransaction per the T1 REQ-JE-007 pattern
...
### Requirement: REQ-CG-006: Inventory GL Posting MUST be reachable through the shillinq manifest navigation
