...
### Requirement: REQ-WMO-001: The system SHALL maintain a Commercial Activity Register per bestuursorgaan
...
### Requirement: REQ-WMO-002: The system SHALL calculate Integral Cost Price per commercial activity per period with time-versioned records
...
### Requirement: REQ-WMO-003: The system SHALL automatically split transactions touching commercial activities per OverheadDistributionRule
...
### Requirement: REQ-WMO-004: The system SHALL export a jaarrekening-bijlage WMO per commercial activity per fiscal year
...
### Requirement: REQ-WMO-005: The system SHALL manage the AlgemeenBelangBesluit (ABB) lifecycle with automatic evaluation scheduling
...
### Requirement: REQ-WMO-006: The system SHALL generate ACM-rapportages in the ACM-standaardformulier 2024 format
...
### Requirement: REQ-WMO-007: The system SHALL detect and alert on cross-subsidy risks monthly
...
### Requirement: REQ-WMO-008: The system SHALL support activity transitions (public ↔ commercial) with openingsbalans and marktwaarde transfer
...
### Requirement: REQ-WMO-009: The system SHALL integrate with raadsvoorstel-besluit workflow for governance coupling (Phase 3)
...
### Requirement: REQ-WMO-010: The system SHALL provide an immutable audit trail meeting ACM-onderzoek standards
...
### Requirement: REQ-WMO-011: The system SHALL support multi-bestuursorgaan (shared services, GR, RUD) with per-deelnemer ABB and per-deelnemer jaarrekening
...
### Requirement: REQ-WMO-012: The system SHALL maintain a market-benchmark register for tariff validation and bevoordeling-risk detection
