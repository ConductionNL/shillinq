...
### Requirement: REQ-WSB-001: The system SHALL support a `bbvVariant: 'waterschap'` overlay on the existing BBV-compliance register
...
### Requirement: REQ-WSB-002: The system SHALL declare the BBVW programma-indeling per `kostentoedeling` rather than per `taakveld`
...
### Requirement: REQ-WSB-003: The system SHALL ship a BBV-Waterschappen programma seed (`bbv-waterschappen-programmas-2026.json`)
...
### Requirement: REQ-WSB-004: The system SHALL declare a `WaterschapHeffingPosting` register for the three sector-specific belastingen
...
### Requirement: REQ-WSB-005: The system SHALL apply the BBVW-specific EMU-saldo exclusion rules in the EMU computation
...
### Requirement: REQ-WSB-006: Waterschappen sector view SHALL be reachable through a feature-flag-controlled manifest navigation entry
