...
### Requirement: REQ-SBR-001: The system SHALL produce SBR/XBRL instance documents from the bookkeeping-financial-statements output as a declarative transformation
...
### Requirement: REQ-SBR-003: The system SHALL declare a state-machine lifecycle on `XbrlInstance` per ADR-031
...
### Requirement: REQ-SBR-005: The system SHALL support the five canonical SBR entry points
