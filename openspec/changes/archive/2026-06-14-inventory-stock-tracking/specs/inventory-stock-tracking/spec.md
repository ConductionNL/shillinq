...
### Requirement: REQ-IST-001: The system SHALL store inventory stock levels as an OpenRegister-managed `InventoryStock` register
...
### Requirement: REQ-IST-002: The `InventoryStock` schema SHALL declare a fixed minimum field set
...
### Requirement: REQ-IST-003: Stock quantity states SHALL express four independent dimensions
...
### Requirement: REQ-IST-004: The system SHALL reference Products from the inventory-product-catalog register
...
### Requirement: REQ-IST-005: The system SHALL reference Locations from the budget-planning-control register
...
### Requirement: REQ-IST-006: Unit cost SHALL be recorded at the time of receipt for standard costing
...
### Requirement: REQ-IST-007: Stock records SHALL support multi-tenancy via organizationId
...
### Requirement: REQ-IST-008: Quantity computation (`quantityAvailable`) MUST be consistent at query time
...
### Requirement: REQ-IST-009: Stock levels SHALL be seeded with realistic Dutch warehouse data on first install
...
### Requirement: REQ-IST-010: Inventory stock SHALL be reachable through the app manifest navigation
...
### Requirement: REQ-IST-011: Status field MUST mirror Product.status for query efficiency
...
### Requirement: REQ-IST-012: Last restock date MUST be set on receipt or manual adjustment
...
### Requirement: REQ-IST-013: Reserved and in-transit quantities MUST NOT exceed on-hand or reasonable limits
