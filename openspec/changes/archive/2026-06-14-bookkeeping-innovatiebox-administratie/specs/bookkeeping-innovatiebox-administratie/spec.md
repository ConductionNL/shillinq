...
### Requirement: REQ-IBA-001: The system SHALL register kwalificerende immateriele activa (IP assets) with validated access-tickets
...
### Requirement: REQ-IBA-002: The system SHALL compute OECD BEPS Action 5 nexus per IP asset per fiscal year
...
### Requirement: REQ-IBA-003: The system SHALL attribute profit per IP asset using three configurable methods
...
### Requirement: REQ-IBA-004: The system SHALL enforce strict cost allocation per asset with doorsnijdingsverbod validation
...
### Requirement: REQ-IBA-005: The system SHALL track innovation losses and carry them forward per asset only
...
### Requirement: REQ-IBA-006: Vpb-aangifte innovatiebox-sectie SHALL render per-asset contributions via docudesk template
...
### Requirement: REQ-IBA-007: Loss carry-forward aggregation MUST prioritize prior-year offsets at full tariff before 9% applies
...
### Requirement: REQ-IBA-008: The system SHALL support VSO (vaststellingsovereenkomst) audit trails for multi-year compliance
...
### Requirement: REQ-IBA-009: The system SHALL provide scenario-testing for nexus impact on taxpayer's Vpb position
...
### Requirement: REQ-IBA-010: Statutory tariff 0.09 (per Wet Vpb art. 12b 2026) SHALL be hard-coded; legislative changes ship as spec updates
