...
### REQ-QOI-005: Invoicing supports multiple triggering modes
...
### REQ-QOI-006: BTW is calculated per line with VIES reverse-charge
...
### REQ-QOI-007: Dutch-compliant invoice numbering, no gaps, no deletion
...
### REQ-QOI-008: E-invoicing produces Peppol BIS 3.0 / UBL 2.1 XML
...
### REQ-QOI-009: Pricing tiers resolved in priority order with line-level transparency
...
### REQ-QOI-010: Automated AR-ageing credit holds and credit notes
