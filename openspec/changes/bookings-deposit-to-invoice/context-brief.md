...
# Booking Deposit-to-Invoice Flow
...
**Lives at:** "Genereer factuur uit aanbetaling" action on booking detail

**Rationale:** Action linking deposit → invoice.  
...
Deposit consumed in final invoice on checkout.

## Priority & Demand

- **Priority:** P0-must
- **Demand evidence:** 18/21 competitors
- **Dependencies:** bookings-deposits
