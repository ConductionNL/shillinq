# Context Brief: Accounts Receivable (Core)
...
**Lives at:** Verkoop / Debiteuren

**Rationale:** AR sub-ledger surface.  
...
### Aged receivables report with customer-level overdue tracking
**demand: 167** (49 tender mentions) | Category: analytics

### Accounts aging report showing overdue invoices by time period
**demand: 125** (39 tender mentions) | Category: analytics

### Accounts receivable aging report with customer-level detail
**demand: 102** (26 tender mentions) | Category: analytics

### Outstanding invoices overview with total receivables
**demand: 90** (28 tender mentions) | Category: other

### Aged receivables report with customer-level aging buckets
