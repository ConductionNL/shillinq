...
- [ ] Fail-soft (no backend) covered by PHPUnit; ObligationTaskBridge existing VTODO path re-tested (no regression)
- [ ] Manual browser test of the category-toggle settings + calendar population
