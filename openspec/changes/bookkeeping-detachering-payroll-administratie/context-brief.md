# Context Brief: Detachering + Payroll Bridge
...
**Lives at:** Salaris / Detachering

**Rationale:** Detachering bridge page.  
...
### Salary administration integration for employee payroll
**demand: 202** (63 tender mentions) | Category: integration

### Financiele Administratie
**demand: 95** (25 tender mentions) | Category: other

### Payroll processing with automatic tax calculation and compliance
**demand: 93** (29 tender mentions) | Category: governance

### Financiele administratie
**demand: 73** (22 tender mentions) | Category: other

### payroll capabilities and needs to be integrated with external payroll software
**demand: 34** (11 tender mentions) | Category: other
