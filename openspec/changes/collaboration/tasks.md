...
- [x] 1.1 Add `Comment` schema to `lib/Settings/shillinq_register.json`
...
- [x] 1.2 Add `CollaborationRole` schema to `lib/Settings/shillinq_register.json`
...
- [x] 1.3 Add `PresenceRecord` schema to `lib/Settings/shillinq_register.json`
...
- [x] 2.1 Add `Comment` seed object to `lib/Repair/CreateDefaultConfiguration.php`
...
- [x] 2.2 Add `CollaborationRole` seed object to `lib/Repair/CreateDefaultConfiguration.php`
  - **spec_ref**: `specs/collaboration/spec.md#REQ-COL-009`
  - **files**: `lib/Repair/CreateDefaultConfiguration.php`
  - **acceptance_criteria**:
...
- [x] 3.1 Create `src/store/modules/comment.js`
...
- [x] 3.2 Create `src/store/modules/collaborationRole.js`
...
- [x] 3.3 Create `src/store/modules/presence.js`
  - **spec_ref**: `specs/collaboration/spec.md#REQ-COL-006`
...
- [x] 4.1 Implement `src/views/comment/CommentList.vue`
  - **spec_ref**: `specs/collaboration/spec.md#REQ-COL-002`
...
- [x] 4.2 Implement `src/views/comment/CommentDetail.vue`
...
- [x] 5.1 Implement `src/views/collaborationRole/CollaborationRoleList.vue`
  - **spec_ref**: `specs/collaboration/spec.md#REQ-COL-005`
...
- [x] 5.2 Implement `src/views/collaborationRole/CollaborationRoleForm.vue`
...
- [x] 6.1 Implement `src/components/DocumentCollaborationPanel.vue`
  - **spec_ref**: `specs/collaboration/spec.md#REQ-COL-002`
...
- [x] 6.2 Implement `src/components/CommentThread.vue`
...
- [x] 6.3 Implement `src/components/CommentInput.vue` with `MentionAutocomplete.vue`
...
- [x] 6.4 Implement `src/components/PresenceStrip.vue`
  - **spec_ref**: `specs/collaboration/spec.md#REQ-COL-006`
...
- [x] 6.5 Implement `src/components/CollaborationRoleChip.vue`
...
- [x] 7.1 Implement `lib/Service/MentionService.php`
  - **spec_ref**: `specs/collaboration/spec.md#REQ-COL-003`
...
- [x] 7.2 Implement `lib/Service/CollaborationRoleService.php`
  - **spec_ref**: `specs/collaboration/spec.md#REQ-COL-005`
...
- [x] 7.3 Implement `lib/Service/PresenceService.php`
  - **spec_ref**: `specs/collaboration/spec.md#REQ-COL-006`
...
- [x] 7.4 Implement `lib/Service/DocumentEventNotifier.php`
...
- [x] 8.1 Implement `lib/Controller/CommentController.php`
  - **spec_ref**: `specs/collaboration/spec.md#REQ-COL-002`
...
- [x] 8.2 Implement `lib/Controller/CollaborationRoleController.php`
  - **spec_ref**: `specs/collaboration/spec.md#REQ-COL-005`
...
- [x] 8.3 Implement `lib/Controller/PresenceController.php`
  - **spec_ref**: `specs/collaboration/spec.md#REQ-COL-006`
...
- [x] 8.4 Register all new routes in `appinfo/routes.php`
...
- [x] 9.1 Embed `DocumentCollaborationPanel` in Invoice, PurchaseOrder, and Contract detail views
...
- [x] 9.2 Update `src/navigation/MainMenu.vue` to add Collaboration section
...
- [x] 9.3 Update `src/router/index.js` with new routes
...
- [x] 10.1 Add English translations for all new UI strings
  - **files**: `l10n/en.json`
  - **acceptance_criteria**:
...
- [x] 11.1 Add unit tests for `MentionService.php`
...
- [x] 11.2 Add unit tests for `CollaborationRoleService.php`
...
- [x] 11.3 Add unit tests for `PresenceService.php`
...
- [x] 11.4 Add unit tests for `DocumentEventNotifier.php`
