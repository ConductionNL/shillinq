 ...
 *
 * Mirrors the constructor in hydra change connection-registry, design D6, and
 * integriq's lib/Event/ConnectionStatusReportedEvent.php verbatim: parameter
 * names, order and defaults. A stub that differs from the real class would
 * encode the caller's bug as correct. tests/bootstrap-unit.php maps the
 * OCA\Integriq namespace here, so a real integriq on the path wins.
 *
