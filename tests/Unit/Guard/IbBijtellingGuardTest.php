...
class IbBijtellingGuardTest extends TestCase
{
    ...
    {
        $bijtelling = $this->guard->computeBijtelling(38000.0, 'REGULAR_22_PCT', 0.17, 30000.0, 0.22);
    ...
    public function testRateIsNotHardCoded(): void
    {
        ...
        $bijtelling = $this->guard->computeBijtelling(40000.0, 'REGULAR_22_PCT', 0.17, 30000.0, 0.25);
