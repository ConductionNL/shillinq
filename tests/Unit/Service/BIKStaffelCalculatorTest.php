...
final class BIKStaffelCalculatorTest extends TestCase
{
    ...
    public function testRenteSplitsAcrossRateBoundary(): void
    {
        ...
        self::assertSame(0.06, $r['perioden'][0]['rate']);
        self::assertSame(0.04, $r['perioden'][1]['rate']);
