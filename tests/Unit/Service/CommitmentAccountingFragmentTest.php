...
final class CommitmentAccountingFragmentTest extends TestCase
{
    ...
    {
        $regel = $this->fragment()['components']['schemas']['CommitmentLine'];
    ...
    public function testSeedDataPopulatesDrilldown(): void
    {
        ...
        $verplichtingen = array_values(array_filter($objects, static fn ($o) => $o['@self']['schema'] === 'Commitment'));
        $regels         = array_values(array_filter($objects, static fn ($o) => $o['@self']['schema'] === 'CommitmentLine'));
