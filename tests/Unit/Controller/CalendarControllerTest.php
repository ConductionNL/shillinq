...
class CalendarControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $tx = false;
        $this->guard->method('beginTransaction')->willReturnCallback(function () use (&$tx): void { $tx = true; });
        $this->guard->method('commit')->willReturnCallback(function () use (&$tx): void { $tx = false; });
        $this->guard->method('rollBack')->willReturnCallback(function () use (&$tx): void { $tx = false; });
        $this->guard->method('inTransaction')->willReturnCallback(function () use (&$tx): bool { return $tx; });
