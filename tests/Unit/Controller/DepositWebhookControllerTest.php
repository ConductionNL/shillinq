 ...
 *
 * @spec openspec/specs/bookings-deposits/spec.md (REQ-DP-006, REQ-DP-001)
 */
...
final class DepositWebhookControllerTest extends TestCase
{
    ...
    private function makeController(
        ...
        return new class($request, $appConfig, $recon, $this->createMock(LoggerInterface::class), $rawBody)
            extends DepositWebhookController {
            /**
