...
interface DunningChannelAdapterInterface
{
     ...
     * @param array<string,mixed> $payload  Channel-specific payload — for EMAIL: subject/body/recipientEmail; for
     *                                      AANGETEKENDE_POST: recipientAdres/letterPdfRef; for INCASSOBUREAU_API:
     *                                      dossier bundle (invoice, dunning runs, incasso kosten, klant, evidence URIs).
     *
