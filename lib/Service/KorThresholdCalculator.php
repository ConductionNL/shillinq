...
class KorThresholdCalculator
{
    ...
    {
        $schijven = [
            ['threshold' => 1.0, 'trigger' => 'THRESHOLD_100_PCT', 'ernst' => 'OVERSCHRIJDING'],
            ['threshold' => 0.9, 'trigger' => 'THRESHOLD_90_PCT', 'ernst' => 'CRITICAL'],
            ['threshold' => 0.8, 'trigger' => 'THRESHOLD_80_PCT', 'ernst' => 'VROEG'],
        ];
