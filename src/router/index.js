...
export default new Router({
	...
	routes: [
		...
		{ path: '/settings', name: 'Settings', component: AdminRoot },
		{
			...
			name: 'RoleIndex',
			component: RoleIndex,
			meta: { breadcrumb: ['Shillinq', 'Security', 'Roles'] },
		},
		{
			path: '/roles/:id',
			name: 'RoleDetail',
			component: RoleDetail,
			meta: { breadcrumb: ['Shillinq', 'Security', 'Roles', ':name'] },
		},
		{
			path: '/teams',
			name: 'TeamIndex',
			component: TeamIndex,
			meta: { breadcrumb: ['Shillinq', 'Security', 'Teams'] },
		},
		{
			path: '/teams/:id',
			name: 'TeamDetail',
			component: TeamDetail,
			meta: { breadcrumb: ['Shillinq', 'Security', 'Teams', ':name'] },
		},
		{
			path: '/users',
			name: 'UserIndex',
			component: UserIndex,
			meta: { breadcrumb: ['Shillinq', 'Security', 'Users'] },
		},
		{
			path: '/users/:id',
			name: 'UserDetail',
			component: UserDetail,
			meta: { breadcrumb: ['Shillinq', 'Security', 'Users', ':name'] },
		},
		{
			path: '/access-log',
			name: 'AccessControlIndex',
			component: AccessControlIndex,
			meta: { breadcrumb: ['Shillinq', 'Security', 'Access Log'] },
		},
		{
			path: '/access-log/:id',
			name: 'AccessControlDetail',
			component: AccessControlDetail,
			meta: { breadcrumb: ['Shillinq', 'Security', 'Access Log', ':action'] },
		},
		{
			path: '/recertifications',
			name: 'RecertificationIndex',
			component: RecertificationIndex,
			meta: { breadcrumb: ['Shillinq', 'Security', 'Recertification'] },
		},
		{
			path: '/recertifications/:id/review',
			name: 'RecertificationReview',
			component: RecertificationReview,
			meta: { breadcrumb: ['Shillinq', 'Security', 'Recertification', 'Review'] },
		},
		{
			path: '/reports/access-rights',
			name: 'AccessRightsReport',
			component: AccessRightsReport,
			meta: { breadcrumb: ['Shillinq', 'Security', 'Reports', 'Access Rights'] },
		},
		{ path: '*', redirect: '/' },
	],
})
